  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.toolbar}>
        ...
        />
        <div style={s.filters}>
          {['All', 'Applied', 'Accepted', 'Waiting List', 'Active', 'Discharged'].map(f => (
            <button
              key={f}
            ...
            <div style={s.modalBody}>
              ...
              {activeTab === 'payments' && (
                <Card title="Payments" full>
                  <p style={{ color: '#666', fontSize: '14px' }}>Payment records will appear here once billing is set up.</p>
                </Card>
              )}
              ...
              {activeTab === 'medications' && (
                <Card title="Medications" full>
                  <p style={{ color: '#666', fontSize: '14px' }}>Medication records will appear here once medication tracking is set up.</p>
                </Card>
              )}

              {activeTab === 'timeline' && (
                <Card title="Timeline" full>
                  <p style={{ color: '#666', fontSize: '14px' }}>Activity timeline will appear here once timeline tracking is set up.</p>
                </Card>
              )}

              {activeTab === 'documents' && (
                <Card title="Documents" full>
                  <p style={{ color: '#666', fontSize: '14px' }}>Documents will appear here once file uploads are set up.</p>
                </Card>
              )}
...
const s = {
  ...
  row: { display: 'flex', alignItems: 'center', padding: '14px 16px', borderBottom: '1px solid #222', cursor: 'pointer', transition: 'background 0.15s' },
  ...
  modalHeader: { display: 'flex', alignItems: 'center', gap: '14px', padding: '16px 20px', borderBottom: '1px solid #333' },
