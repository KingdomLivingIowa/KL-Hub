...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const email = app.email || app.correspondence_contact || null;
    ...
    return new Response(JSON.stringify({ result: 'accepted' }), { status: 200, headers: { ...corsHeaders, 'Content-Type': 'application/json' } });
